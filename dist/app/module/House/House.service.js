...
exports.HouseServices = void 0;
const House_model_1 = require("./House.model");
const createHouseService = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield House_model_1.HouseModel.create(data);
    return result;
});
